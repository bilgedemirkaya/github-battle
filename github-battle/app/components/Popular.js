...
function LanguagesNav({selected,onUpdateLanguage}){
    ...
    return (
    <ul className='flex-center'> {languages.map((language) => (
        <li key={language}>
    ...
    updateLanguage(selectedLanguage){
        ...
        if (!this.state.repos[selectedLanguage]){
            ...
            .then((data) =>{
                // confusion here
                this.setState(({repos})=>({
                    repos: { // get the repos object
                        ...repos, // keep previous data 
                        [selectedLanguage]:data // update the selected languge data
                    }
